...
option(BGFX_SHADERC_ENABLE_WGSL "Build WGSL support into shaderc." OFF)

set(BGFX_SHADERC_LIBS
	bx
	bimg
	bgfx-vertexlayout
	fcpp
...
if(BGFX_SHADERC_ENABLE_WGSL)
	list(APPEND BGFX_SHADERC_LIBS webgpu tint)
endif()

target_link_libraries(
	shaderc
	PRIVATE ${BGFX_SHADERC_LIBS}
)
